...
@Grapes([
    ...
    @Grab(group='com.h3xstream.findsecbugs' , module='findsecbugs-plugin', version='1.9.0')]
)
...
FSB = new Plugin(groupId: 'com.h3xstream.findsecbugs', artifactId: 'findsecbugs-plugin', version: '1.9.0')
