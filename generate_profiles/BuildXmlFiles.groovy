...
@Grapes([
    ...
    @Grab(group='com.mebigfatguy.sb-contrib', module='sb-contrib', version='7.6.10'),
...
CONTRIB = new Plugin(groupId: 'com.mebigfatguy.sb-contrib', artifactId: 'sb-contrib', version: '7.6.10')
