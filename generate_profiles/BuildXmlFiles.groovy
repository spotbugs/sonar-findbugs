...
@Grapes([
    ...
    @Grab(group='com.github.spotbugs', module='spotbugs', version='4.10.2'),
    @Grab(group='com.mebigfatguy.sb-contrib', module='sb-contrib', version='7.7.4'),
    @Grab(group='com.h3xstream.findsecbugs' , module='findsecbugs-plugin', version='1.14.0')]
)


FB = new Plugin(groupId: 'com.github.spotbugs', artifactId: 'spotbugs', version: '4.10.2')
CONTRIB = new Plugin(groupId: 'com.mebigfatguy.sb-contrib', artifactId: 'sb-contrib', version: '7.7.4')
        ...
        def buildPattern = { pattern ->
            ...
            if((includedBugs.isEmpty() || includedBugs.contains(pattern.attribute("type"))) && !excludedBugs.contains(pattern.attribute("type"))) {
                ...
                rule(key: pattern.attribute("type"),
                    ...
                    if (pattern.Details.text().toLowerCase().contains('wiki.sei.cmu.edu') || pattern.Details.text().toLowerCase().contains('cmu-sei.github.io')) {
						tag('cert')
					}
